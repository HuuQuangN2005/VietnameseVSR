...
# Source (modified): https://github.com/mpc001/auto_avsr/blob/main/espnet/nets/pytorch_backend/transformer/decoder.py
...
from srcs.nets.backend.transformer.attention import MultiHeadedAttention
