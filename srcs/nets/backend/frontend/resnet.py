# Source (modified): https://github.com/mpc001/auto_avsr/blob/main/espnet/nets/pytorch_backend/frontend/resnet.py
...
class Conv3dResNet(nn.Module):
    ...
    def __init__(self, backbone_type="resnet", relu_type="swish"):
        ...
        :param relu_type: str, activation function used in the visual front-end.
        """
