...
# Source path: espnet/nets/pytorch_backend/encoder/conformer_encoder.py

"""Encoder definition."""

import copy
import torch
from srcs.nets.pytorch_backend.nets_utils import rename_state_dict
from srcs.nets.pytorch_backend.transformer.attention import (
    RelPositionMultiHeadedAttention,
)
from srcs.nets.pytorch_backend.transformer.embedding import RelPositionalEncoding
from srcs.nets.pytorch_backend.transformer.layer_norm import LayerNorm
from srcs.nets.pytorch_backend.transformer.positionwise_feed_forward import (
    PositionwiseFeedForward,
)
from srcs.nets.pytorch_backend.transformer.repeat import repeat
