# Source (modified): https://github.com/nguyenvulebinh/AVSRCocktail/blob/main/src/nets/scorers/ctc.py
...
from srcs.nets.ctc_prefix_score import CTCPrefixScore, CTCPrefixScoreTH
from srcs.nets.scorer_interface import BatchPartialScorerInterface
